            ...
            <div id="content" className="mt-3">
                <table className="table text-muted text-center">
                    ...
                    <tr style={{color:'black'}}>
                        ...
                        <th scope="col">BLM Reward Balance</th>
                    </tr>
                    </thead> 
                    ...
                    <tr style={{color:'black'}}>
                        ...
                        <td>{window.web3.utils.fromWei(this.props.blmBalance, 'Ether')} BLM</td>
                    </tr>
                    </tbody>
                </table> 
                ...
                <div className="card mb-2" style={{opacity:'.9'}}>
                    ...
                    className="mb-3">
                        <div style={{borderSpacing:'0 1em'}}>
                            ...
                            <button type="submit" className="btn btn-info btn-lg btn-block" >Stake</button>
                        </div>
                    </form>
                    <button 
                    type="submit"
                    ...
                    className="btn btn-dark btn-lg btn-block" >Unstake</button>
